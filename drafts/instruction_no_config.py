...
def run_instruction_finetuning_flow(models_dir: str, model_size: str, tuning_set_path: str, train_frac: float = 0.85,
    ...
    model = load_tf_weights_into_gpt(model_size, models_dir)
    model.eval()
