...
This module implements a GPT (Generative Pre-trained Transformer) model architecture similar to the OpenAI GPT-2 model.
The implementation includes the main GptModel class with token and positional embeddings, transformer blocks, layer
normalization, and text generation capabilities using both greedy and softmax-based sampling strategies.
"""
